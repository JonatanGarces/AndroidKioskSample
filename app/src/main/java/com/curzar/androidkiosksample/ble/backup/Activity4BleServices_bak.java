...
public class Activity4BleServices_bak extends Activity {
    private final static String TAG = Activity4BleServices_bak.class.getSimpleName();
    ...
    public boolean characteristic_notify(int groupPosition,
                                         int childPosition){
        ...
        public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
            ...
            if (actionId == EditorInfo.IME_ACTION_SEND) {
                if (mBluetoothLeService != null && bluetoothGattCharacteristicBLE != null) {
                    ...
                    Toast.makeText(Activity4BleServices_bak.this, "Done", Toast.LENGTH_SHORT).show();
...
//        getActionBar().setTitle(mDeviceName);
  //      getActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void displayData(String data) {
        if (data != null) {
          // int moneda =  Integer.parseInt(data.replaceFirst("^0+(?!$)", "")
          // );
